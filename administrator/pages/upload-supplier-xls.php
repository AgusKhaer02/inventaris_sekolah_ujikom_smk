...
<div class="page-header">
    <h1>
        Supplier <small>Import XLS</small>
    </h1>
</div>
...
<div class="row">
    ...
    <div class="col-xs-5">
        <form action="includes/actions/up_supplier_xls.php" method="post" enctype="multipart/form-data">
    ...
    <div class="col-xs-12 col-sm-7" >
        <div class="widget-box widget-color-green" id="widget-box-2">
            ...
            <div class="widget-body" style="overflow:scroll;">
                <div class="widget-main padding-8">
                    <img src="../assets/images/contohSupplierxls.png" alt="../assets/images/contohDataBarangxls.png">
                </div>
            </div>
        </div>
    </div>
