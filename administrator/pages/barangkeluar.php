        ...
        <table id="dataTables" class="table table-bordered table-hover" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="?page=EditBarangKeluar&<?php echo "id_brg_keluar=".$value[0]."&id_brg=".$value[1]."&nama_barang=".$value[2]."&jml_keluar=".$value[3]."&lokasi=".$value[4]."&penerima=".$value[5]."&tgl_keluar=".$value[6];?>" class="btn btn-sm btn-warning"><i class="fa fa-fw fa-edit"></i></a> <a onclick="return confirm('Apakah anda ingin menghapus data ini?')" href="includes/actions/aksihapusbarangkeluar.php?id_keluar_barang=<?php echo $value[0]?>" class="btn btn-sm btn-danger"><i class="fa fa-fw fa-eraser"></i></a></td>
                </tr>
                <?php
                    }
                ?>
