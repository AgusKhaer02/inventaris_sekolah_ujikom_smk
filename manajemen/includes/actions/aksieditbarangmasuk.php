...
$q_insert_data = $conn->getConn()->prepare("UPDATE barang_masuk SET id_barang=:val2,nama_barang=(SELECT nama_barang FROM barang WHERE id_barang=:val2),tgl_masuk=:val4,jml_masuk=:val5,id_supplier=:val6 WHERE id_masuk_barang=:val1");
...
if ($q_insert_data){
    header("location:../../index.php?page=BarangMasuk&alert=EditSuccess");
}
?>